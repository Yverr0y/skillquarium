...
> **Webhook setup details:** See the **[zoom-webhooks](../setup-zoom-webhooks/SKILL.md)** skill for comprehensive webhook implementation.
...
2. Cross-reference: [zoom-webhooks](../setup-zoom-webhooks/SKILL.md) for comprehensive webhook docs
3. Cross-reference: [zoom-websockets](../setup-zoom-websockets/SKILL.md) for WebSocket events
...
| **[zoom-webhooks](../setup-zoom-webhooks/SKILL.md)** | Deep webhook implementation, event catalog |
| **[zoom-websockets](../setup-zoom-websockets/SKILL.md)** | WebSocket event streaming |
