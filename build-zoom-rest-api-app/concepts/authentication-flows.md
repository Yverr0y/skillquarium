...
> **Complete OAuth implementation guide:** See the **[zoom-oauth](../zoom-oauth/SKILL.md)** skill for full code examples, token storage, and production patterns.
...
- **Full OAuth Skill**: See **[zoom-oauth](../zoom-oauth/SKILL.md)**
