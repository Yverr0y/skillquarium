...
1. [`skills/shared/template/SKILL.md`](../template/SKILL.md) — authoring rules (which
   classes / snippets are owned by the shared layer, allowed per-skill overrides, outlook-badge
   usage).
2. [`skills/shared/template/assets/template.html`](../template/assets/template.html) —
...
1. [`skills/shared/citations/SKILL.md`](../citations/SKILL.md) — authoring rules
   (numbering, hyperlinking, source data shape, carve-outs).
2. [`skills/shared/citations/assets/template.html`](../citations/assets/template.html) —
...
`#ecs-sources` are defined in [skills/shared/citations/SKILL.md](../citations/SKILL.md).
...
- `#ecs-cite-a` … `#ecs-cite-l` — optional per-section recap blocks. Use the
  ...
  [skills/shared/citations/SKILL.md](../citations/SKILL.md). Omit any section's block
  if empty.
...
(`#ecs-sources`): see [skills/shared/citations/SKILL.md](../citations/SKILL.md) for the
...
- Emit inline citations per [skills/shared/citations/SKILL.md](../citations/SKILL.md). Inline citations are the primary attribution mechanism — the optional per-section blocks (`#ecs-cite-a` … `#ecs-cite-l`) remain available as supplementary summary boxes. Numeric `.yoy-change` cells stay citation-free.
...
- Inline citations follow the shared citations skill — read [skills/shared/citations/SKILL.md](../citations/SKILL.md) before authoring any `[n]` reference or the Citations block.
