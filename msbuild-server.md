...
domain: dotnet-development
status: untried
source: skills/msbuild-server/SKILL.md
created: 2026-07-21
---
...
**Source:** [skills/msbuild-server/SKILL.md](skills/msbuild-server/SKILL.md)  ·  **Domain:** [.NET & C# Development](maps/dotnet-development.md)  ·  **Table:** [skills.base](skills.base)  ·  **Index:** [Skills Index](index.md)
