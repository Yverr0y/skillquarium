...
- If the user is implementing Contact Center app surfaces inside Zoom client, chain with [../build-zoom-contact-center-app/SKILL.md](../build-zoom-contact-center-app/SKILL.md).
- If the user needs backend knowledge-base CRUD or automation scripts, chain with [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md) and [../zoom-oauth/SKILL.md](../zoom-oauth/SKILL.md).
...
- Contact Center app/web/mobile patterns: [../build-zoom-contact-center-app/SKILL.md](../build-zoom-contact-center-app/SKILL.md)
- OAuth app setup and tokens: [../zoom-oauth/SKILL.md](../zoom-oauth/SKILL.md)
- API workflows for KB automation: [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md)
- Event-driven backend follow-up: [../setup-zoom-webhooks/SKILL.md](../setup-zoom-webhooks/SKILL.md)
