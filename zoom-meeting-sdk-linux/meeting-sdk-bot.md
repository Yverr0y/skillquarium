...
**Alternative:** See [rtms/examples/rtms-bot.md](../zoom-rtms/examples/rtms-bot.md) for invisible, read-only access via RTMS.
...
- **RTMS Bot Alternative**: [../zoom-rtms/examples/rtms-bot.md](../zoom-rtms/examples/rtms-bot.md)
