...
**Alternative:** See [Meeting SDK Bot (Linux)](../build-zoom-meeting-sdk-app/linux/meeting-sdk-bot.md) for visible participant bots with full meeting control.
...
- **Meeting SDK Bot Alternative**: [Meeting SDK Bot (Linux)](../build-zoom-meeting-sdk-app/linux/meeting-sdk-bot.md)
