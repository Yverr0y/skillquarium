...
- If the user needs **live meeting media** without file-based upload/batch jobs, route to [../zoom-rtms/SKILL.md](../zoom-rtms/SKILL.md).
- If the user needs **Zoom REST API inventory** for AI Services paths, chain [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md).
- If the user needs webhook signature patterns or generic HMAC receiver hardening, optionally chain [../setup-zoom-webhooks/SKILL.md](../setup-zoom-webhooks/SKILL.md).
...
- If the user asks for actual live stream ingestion, low-latency continuous media, or server-push media transport, route to [../zoom-rtms/SKILL.md](../zoom-rtms/SKILL.md) instead.
...
- Stored Zoom recordings -> [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md) + `scribe`
- Webhook verification hardening -> [../setup-zoom-webhooks/SKILL.md](../setup-zoom-webhooks/SKILL.md)
- Real-time live transcript/media -> [../zoom-rtms/SKILL.md](../zoom-rtms/SKILL.md)
- Cross-product routing -> [../zoom-general/SKILL.md](../zoom-general/SKILL.md)
