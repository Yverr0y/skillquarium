---
title: matlab-define-toolbox-api
aliases:
...
- [matlab-analyze-dependencies](matlab-analyze-dependencies.md) — Analyze the effective toolbox file set to produce a Dependency Manifest — classify all transitive dependencies as included, product, add-on, or external-unresolved, then present...
