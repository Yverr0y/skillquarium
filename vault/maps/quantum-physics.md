...
**Related maps:** [Data Science, Stats & Scientific Computing](data-science-compute.md) | [Machine Learning & AI](ml-ai.md)

## Skills (7)

- [astropy](../notes/quantum-physics/astropy.md) — Core Python library for astronomy and astrophysics workflows that need Astropy APIs, including units/quantities, coordinates, FITS I/O, tables, time systems, WCS, and cosmology
...
- [fluidsim](../notes/quantum-physics/fluidsim.md) — Framework for computational fluid dynamics simulations using Python
- [pennylane](../notes/quantum-physics/pennylane.md) — Hardware-agnostic quantum ML framework with automatic differentiation
- [pymatgen](../notes/quantum-physics/pymatgen.md) — Materials science toolkit. Crystal structures (CIF, POSCAR), phase diagrams, band structure, DOS, Materials Project integration, format conversion, for computational materials science
