...
- [obsidian-markdown](../notes/vault-meta/obsidian-markdown.md) — Create and edit Obsidian Flavored Markdown with wikilinks, embeds, callouts, properties, and other Obsidian-specific syntax
- [obsidian-vault](../notes/vault-meta/obsidian-vault.md) — Search, create, and manage notes in the Obsidian vault with wikilinks and index notes
- [plugin-creator](../notes/vault-meta/plugin-creator.md) — Create and scaffold plugin directories for Codex with a required `.codex-plugin/plugin.json`, optional plugin folders/files, and baseline placeholders you can edit before publishing or...
- [plugin-eval](../notes/vault-meta/plugin-eval.md) — Help engineers evaluate a local skill or plugin, explain why it scored that way, show what to fix first, measure real token usage, benchmark starter scenarios, or decide what to run...
...
- [writing-great-skills](../notes/vault-meta/writing-great-skills.md) — Reference for writing and editing skills well — the vocabulary and principles that make a skill predictable
- [yeet](../notes/vault-meta/yeet.md) — Publish local changes to GitHub by confirming scope, committing intentionally, pushing the branch, and opening a draft PR through the GitHub app from this plugin, with `gh` used only...
