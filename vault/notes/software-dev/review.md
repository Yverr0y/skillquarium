...
- [bio-manuscript-refine](../../notes/research-writing/bio-manuscript-refine.md) — Refinement loop for the bio-manuscript pipeline: three-reviewer iterative optimization (editor, computational, biological)
...
- [pre-submission-reviewer](../../notes/research-writing/pre-submission-reviewer.md) — Runs a pre-submission review of a technical paper across five dimensions: macro logic, writing details, English grammar, LaTeX formatting, and figure quality
...
- [research-grants](../../notes/research-writing/research-grants.md) — Write competitive research proposals for NSF, NIH, DOE, and DARPA
...
- [sds-gel-review](../../notes/proteomics-metabolomics/sds-gel-review.md) — Review SDS-PAGE or protein purification gel images using DNA sequence, protein sequence, base-pair length, expected protein size, and lane labels
