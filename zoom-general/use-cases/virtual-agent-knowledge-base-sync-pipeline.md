...
2. [zoom-rest-api](../build-zoom-rest-api-app/SKILL.md)
3. [zoom-oauth](../zoom-oauth/SKILL.md)
...
- [Virtual Agent Environment Variables](../build-zoom-virtual-agent/references/environment-variables.md)
- [Virtual Agent Troubleshooting](../build-zoom-virtual-agent/troubleshooting/common-drift-and-breaks.md)
- [REST API Skill](../build-zoom-rest-api-app/SKILL.md)
