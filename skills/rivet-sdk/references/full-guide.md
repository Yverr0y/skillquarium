...
- If the user only needs direct API calls from an existing backend, chain with [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md).
- If the user is focused on Zoom Team Chat app cards/commands behavior, chain with [../build-zoom-team-chat-app/SKILL.md](../build-zoom-team-chat-app/SKILL.md).
- If the user needs SDK embed (Meeting SDK/Video SDK client runtime), route to [../build-zoom-meeting-sdk-app/SKILL.md](../build-zoom-meeting-sdk-app/SKILL.md) or [../build-zoom-video-sdk-app/SKILL.md](../build-zoom-video-sdk-app/SKILL.md).
...
- OAuth architecture and grant selection: [../zoom-oauth/SKILL.md](../zoom-oauth/SKILL.md)
- API endpoint semantics and request payload details: [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md)
- Team Chat app cards, command and bot UX: [../build-zoom-team-chat-app/SKILL.md](../build-zoom-team-chat-app/SKILL.md)
- Video SDK API-specific behavior and BYOS context: [../build-zoom-video-sdk-app/SKILL.md](../build-zoom-video-sdk-app/SKILL.md)
