...
`#pa-sources` are defined in [skills/shared/citations/SKILL.md](../citations/SKILL.md).
...
- `#pa-cite-peers` — optional `<div class="section-citations">…</div>` recap for the
  ...
  [skills/shared/citations/SKILL.md](../citations/SKILL.md). Omit if empty.
...
[skills/shared/citations/SKILL.md](../citations/SKILL.md) for the canonical markup.
...
- Emit inline citations per [skills/shared/citations/SKILL.md](../citations/SKILL.md).
...
- Inline citations follow the shared citations skill — read
  [skills/shared/citations/SKILL.md](../citations/SKILL.md) before authoring any `[n]`
