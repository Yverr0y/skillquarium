...
description: >
  Expert-thinking profile for String Theorist (formal hep-th / compactification & moduli
  stabilization / AdS-CFT holography / swampland & string phenomenology): Reasons from
  worldsheet CFT anomaly cancellation, moduli stabilization, and effective-field-theory
  consistency through KKLT/LVS flux compactifications, KLT/CHY/BCFW amplitude methods,
  and AdS/CFT large-N holography while treating tadpole mismatches, runaway moduli,
  unstabilized de Sitter uplifts, and...
metadata:
  short-description: String Theorist expert profile
