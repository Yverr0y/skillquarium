...
See [Rate Limits](../build-zoom-rest-api-app/references/rate-limits.md) for detailed information.
...
Multiple rendering controls severely degrade performance. See [Video SDK Web](../build-zoom-video-sdk-app/web/references/web.md#video-rendering-best-practices).
