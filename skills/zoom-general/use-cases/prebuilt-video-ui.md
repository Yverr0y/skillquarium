...
- **[zoom-video-sdk](../build-zoom-video-sdk-app/SKILL.md)** - Raw Video SDK (when UI Toolkit isn't enough)
...
2. **Migrate to raw Video SDK**:
   ...
   - See [zoom-video-sdk](../build-zoom-video-sdk-app/SKILL.md) for migration guide
