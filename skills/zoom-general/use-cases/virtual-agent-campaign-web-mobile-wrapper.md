...
1. [virtual-agent](../build-zoom-virtual-agent/SKILL.md)
2. [virtual-agent/web](../zoom-virtual-agent-web/SKILL.md)
3. [virtual-agent/android](../zoom-virtual-agent-android/SKILL.md) or [virtual-agent/ios](../zoom-virtual-agent-ios/SKILL.md)
4. [contact-center](../build-zoom-contact-center-app/SKILL.md)
...
- [Virtual Agent Root Skill](../build-zoom-virtual-agent/SKILL.md)
- [Web Lifecycle and Events](../zoom-virtual-agent-web/concepts/lifecycle-and-events.md)
- [Android JS Bridge Patterns](../zoom-virtual-agent-android/examples/js-bridge-patterns.md)
- [iOS JS Bridge Patterns](../zoom-virtual-agent-ios/examples/js-bridge-patterns.md)
