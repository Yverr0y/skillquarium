...
**Solution**: Implement auto-reconnection (see [Auto-Reconnection Guide](../zoom-cobrowse-sdk/examples/auto-reconnection.md))
...
3. **Set up auth server** using [JWT Authentication](../zoom-cobrowse-sdk/concepts/jwt-authentication.md)
4. **Integrate customer SDK** using [Customer Integration](../zoom-cobrowse-sdk/examples/customer-integration.md)
