...
> **For comprehensive webhook documentation**, see the **[webhooks skill](../setup-zoom-webhooks/SKILL.md)**.
...
> **See complete event catalog**: [webhooks skill](../setup-zoom-webhooks/SKILL.md)

## Related Documentation

- **[webhooks skill](../setup-zoom-webhooks/SKILL.md)** - Comprehensive webhook documentation
