...
- If user needs embedded meeting flows, route to [../build-zoom-meeting-sdk-app/SKILL.md](../build-zoom-meeting-sdk-app/SKILL.md).
- If user needs custom real-time session UX, route to [../build-zoom-video-sdk-app/SKILL.md](../build-zoom-video-sdk-app/SKILL.md).
- If user needs backend orchestration of events/APIs, chain with [../rivet-sdk/SKILL.md](../rivet-sdk/SKILL.md), [../zoom-oauth/SKILL.md](../zoom-oauth/SKILL.md), and [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md).
...
- Meeting pre-join gate: [../build-zoom-meeting-sdk-app/SKILL.md](../build-zoom-meeting-sdk-app/SKILL.md)
- Video session readiness gate: [../build-zoom-video-sdk-app/SKILL.md](../build-zoom-video-sdk-app/SKILL.md)
- Telemetry/report ingestion backend: [../rivet-sdk/SKILL.md](../rivet-sdk/SKILL.md) + [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md)
