...
[skills/shared/citations/SKILL.md](../citations/SKILL.md) — read it before authoring
any `[n]` reference.
...
38. `#pib-sources` — end-of-document Citations rows. One `<div class="source-item">` per
    ...
    [skills/shared/citations/SKILL.md](../citations/SKILL.md). Numbering must match
    inline `[n]` references.
...
| `#pib-cite-{a..k}` | Optional per-section recap as one `<div class="section-citations">…</div>` (markup defined in [skills/shared/citations/SKILL.md](../citations/SKILL.md)). Empty when the corresponding section carries no inline `[n]` references. |
...
[skills/shared/citations/SKILL.md](../citations/SKILL.md).
...
- Citation references `[n]` are used inline throughout narrative text per
  [skills/shared/citations/SKILL.md](../citations/SKILL.md). Never put citation markup
