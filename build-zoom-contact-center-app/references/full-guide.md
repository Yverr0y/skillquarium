...
- If the user needs Contact Center call-control or queue APIs, chain with [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md).
...
- Auth and in-client app identity: [../zoom-apps-sdk/SKILL.md](../zoom-apps-sdk/SKILL.md) and [../zoom-oauth/SKILL.md](../zoom-oauth/SKILL.md)
- Contact Center REST workflows: [../build-zoom-rest-api-app/SKILL.md](../build-zoom-rest-api-app/SKILL.md)
- Cobrowse on web voice/chat channels: [../zoom-cobrowse-sdk/SKILL.md](../zoom-cobrowse-sdk/SKILL.md)
